...
function ScrollControls({
  ...
  const state = React.useMemo(() => {
    ...
    // return state
  }, [el, fill, fixed, eps, damping, horizontal, pages])
  ...
  }, [pages, distance, gl.domElement, raycaster, horizontal, el, fill, fixed, target])
